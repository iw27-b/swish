...
const HomeInformationSection: React.FC = () => {
  return (
    <section className="px-5 sm:px-10 pt-[120px] pb-[240px]">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8">
        {/* Latest Information */}
        <div className="bg-[url('/images/img3-1.png')] bg-cover bg-center rounded-3xl sm:rounded-[3rem] p-8 sm:p-12 min-h-[400px] sm:min-h-[500px] relative overflow-hidden flex items-center justify-center">
        ...
        {/* Community Culture */}
        <div className="bg-[url('/images/img4.png')] bg-cover bg-center rounded-3xl sm:rounded-[3rem] p-8 sm:p-12 min-h-[400px] sm:min-h-[500px] relative overflow-hidden flex items-center justify-center">
          <div className="text-center text-white relative z-10">
