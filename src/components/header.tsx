    ...
    <header className="px-2 sm:px-4 py-6">
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between w-full max-w-screen-lg xl:max-w-screen-xl mx-auto gap-0">
        ...
        <div className="flex items-center justify-center w-full lg:hidden">
          ...
          >
            ...
            <div className="flex items-center gap-3">
              <Link
                href="/cart"
                className="px-3 py-2 bg-black text-white rounded-full font-semibold text-sm hover:bg-gray-900 transition-all shadow-sm flex items-center"
                style={{
                  borderRadius: "9999px",
                  minWidth: "44px",
                  height: "40px",
              ...
              <Link
                href="/me"
                className="w-10 h-10 rounded-full bg-transparent border border-black flex items-center justify-center flex-shrink-0"
            ...
            {navItems.map((item, index) => {
              ...
              return (
                <Link
                  ...
                  href={item.href}
                  className={[
                    "relative z-10 px-3 h-7 inline-flex items-center justify-center rounded-full transition-colors",
                    isActive
                      ? "bg-black text-white"
        ...
        <nav className="hidden lg:flex items-center text-sm uppercase font-medium">
          <div
            ref={containerRef}
            className="relative flex items-center gap-3 px-1 py-1 flex-shrink-0"
        ...
        <div
          className="hidden lg:flex items-center gap-3 justify-self-end"
          style={{ minWidth: 0 }}
        >
          <Link
            href="/cart"
