    ...
    <div className="w-full max-w-[1000px] ml-16 font-sans leading-[1.6]">
      ...
      <div className="space-y-6 mb-8">
        <div className="grid gap-2">
          <label htmlFor="username" className="font-bold text-[14px] text-[#333]">
            ユーザー名前
          </label>
          <input
            id="username"
        ...
        <div className="grid gap-2">
          <label htmlFor="email" className="font-bold text-[14px] text-[#333]">
            メールアドレス
          </label>
          <input
            id="email"
        ...
        <div className="grid gap-2">
          <label htmlFor="password" className="font-bold text-[14px] text-[#333]">
            パスワード
          </label>
          <input
            id="password"
