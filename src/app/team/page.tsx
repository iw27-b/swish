    ...
    return (
        <main className="mx-auto max-w-[1100px] px-4 py-6">
            ...
            <section className="relative mx-auto mb-7 w-[clamp(260px,46vw,520px)]">
                ...
                <span className="absolute left-[-60px] top-[12%] flex h-20 w-20 items-center justify-center rounded-full bg-[#efefef] will-change-transform float-soft v1">
                    <Image src="/images/team/2.png" alt="" className="h-[70%] w-[70%]" width={70} height={70} />
                </span>
                <span className="absolute right-[-60px] top-[18%] flex h-20 w-20 items-center justify-center rounded-full bg-[#efefef] will-change-transform float-soft v2">
                    <Image src="/images/team/4.png" alt="" className="block h-[70%] w-[70%]" width={70} height={70} />
                </span>
                <span className="absolute left-[-60px] top-[65%] flex h-20 w-20 items-center justify-center rounded-full bg-[#efefef] will-change-transform float-soft v3">
                    <Image src="/images/team/5.png" alt="" className="block h-[70%] w-[70%]" width={70} height={70} />
                </span>
                <span className="absolute right-[-60px] top-[72%] flex h-20 w-20 items-center justify-center rounded-full bg-[#efefef] will-change-transform float-soft v4">
            ...
            <div className="flex justify-center">
                <section className="mx-auto my-10 max-w-[800px] leading-relaxed text-left">
                    ...
                    <h2 className="mt-12 mb-5 text-[22px] font-bold">チームメンバー</h2>
