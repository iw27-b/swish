...
const rolePermissions: Record<Role, { grants: Array<{ resource: string; action: string; condition?: (req: NextRequest, user: JwtPayload) => boolean }> }> = {
    [Role.USER]: {
        grants: [
            ...
            { resource: 'payment_methods', action: 'read:own' },
            { resource: 'payment_methods', action: 'create:own' },
            { resource: 'payment_methods', action: 'delete:own' },
            { resource: 'cart', action: 'read:own' },
            { resource: 'cart', action: 'create:own' },
            { resource: 'cart', action: 'delete:own' },
        ],
    },
    [Role.SELLER]: {
        grants: [
    ...
    [Role.ADMIN]: {
        grants: [
            ...
            { resource: 'payment_methods', action: 'read:any' },
            { resource: 'payment_methods', action: 'create:any' },
            { resource: 'payment_methods', action: 'delete:any' },
            { resource: 'cart', action: 'read:any' },
            { resource: 'cart', action: 'create:any' },
            { resource: 'cart', action: 'delete:any' },
        ],
    },
};
